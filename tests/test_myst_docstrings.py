...
# Make the local Sphinx extension importable.
sys.path.insert(0, str(Path(__file__).parent.parent / "docs" / "_ext"))

from myst_docstrings import myst_to_rst
...
def test_idempotent_full_rst_docstring():
    """A complete reST docstring from the codebase passes through."""
    text = (
...
# ---- Realistic docstring patterns from the codebase -------------------------
