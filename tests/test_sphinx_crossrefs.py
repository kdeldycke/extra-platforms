...
@pytest.mark.parametrize(
    ("role_type", "reference", "expected_href", "expected_text"),
    [
        pytest.param(
            "func",
        ...
        pytest.param(
            "func",
            "~extra_platforms.current_architecture",
        ...
        pytest.param(
            "func",
            "~extra_platforms.current_platform",
...
def test_crossref_links_to_correct_page(
    sphinx_app, role_type, reference, expected_href, expected_text
):
    ...
    content = dedent(f"""
        ...
        Here is a reference: {{{role_type}}}`{reference}`
    """)
