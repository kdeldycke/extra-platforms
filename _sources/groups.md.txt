...
flowchart
    ...
    subgraph "<code>extra_platforms.ALL_ARCHITECTURES</code><br/>🏛️ <em>All architectures</em>"
        all_architectures_aarch64(<code>aarch64</code><br/>🔋 <em>ARM64 (AArch64)</em>)
        all_architectures_arm(<code>arm</code><br/>📱 <em>ARM (32-bit)</em>)
        all_architectures_armv6l(<code>armv6l</code><br/>📱 <em>ARMv6 (little-endian)</em>)
        all_architectures_armv7l(<code>armv7l</code><br/>📱 <em>ARMv7 (little-endian)</em>)
        all_architectures_armv8l(<code>armv8l</code><br/>📱 <em>ARMv8 (32-bit, little-endian)</em>)
        all_architectures_i386(<code>i386</code><br/>🔲 <em>Intel 80386 (i386)</em>)
        all_architectures_i586(<code>i586</code><br/>🔲 <em>Intel Pentium (i586)</em>)
        all_architectures_i686(<code>i686</code><br/>🔲 <em>Intel Pentium Pro (i686)</em>)
        all_architectures_loongarch64(<code>loongarch64</code><br/>🐉 <em>LoongArch (64-bit)</em>)
        all_architectures_mips(<code>mips</code><br/>🔧 <em>MIPS (32-bit, big-endian)</em>)
        all_architectures_mips64(<code>mips64</code><br/>🔧 <em>MIPS64 (big-endian)</em>)
        all_architectures_mips64el(<code>mips64el</code><br/>🔧 <em>MIPS64 (little-endian)</em>)
        all_architectures_mipsel(<code>mipsel</code><br/>🔧 <em>MIPS (32-bit, little-endian)</em>)
        ...
        all_architectures_sparc(<code>sparc</code><br/>☀️ <em>SPARC (32-bit)</em>)
        all_architectures_sparc64(<code>sparc64</code><br/>☀️ <em>SPARC (64-bit)</em>)
        ...
        all_architectures_x86_64(<code>x86_64</code><br/>💻 <em>x86-64 (AMD64)</em>)
    end
    subgraph "<code>extra_platforms.ALL_CI</code><br/>♺ <em>All CI systems</em>"
        all_ci_azure_pipelines(<code>azure_pipelines</code><br/>═ <em>Azure Pipelines</em>)
        all_ci_bamboo(<code>bamboo</code><br/>⟲ <em>Bamboo</em>)
        all_ci_buildkite(<code>buildkite</code><br/>🪁 <em>Buildkite</em>)
        all_ci_circle_ci(<code>circle_ci</code><br/>⪾ <em>Circle CI</em>)
        all_ci_cirrus_ci(<code>cirrus_ci</code><br/>≋ <em>Cirrus CI</em>)
        all_ci_codebuild(<code>codebuild</code><br/>ᚙ <em>CodeBuild</em>)
        all_ci_github_ci(<code>github_ci</code><br/>🐙 <em>GitHub Actions runner</em>)
        all_ci_gitlab_ci(<code>gitlab_ci</code><br/>🦊 <em>GitLab CI</em>)
        all_ci_heroku_ci(<code>heroku_ci</code><br/>⥁ <em>Heroku CI</em>)
        all_ci_teamcity(<code>teamcity</code><br/>🏙️ <em>TeamCity</em>)
        all_ci_travis_ci(<code>travis_ci</code><br/>👷 <em>Travis CI</em>)
        all_ci_unknown_ci(<code>unknown_ci</code><br/>♲ <em>Unknown CI</em>)
    end
...
flowchart
    ...
    subgraph "<code>extra_platforms.ALL_TRAITS</code><br/>⁕ <em>Any architectures, platforms and CI systems</em>"
        all_traits_aarch64(<code>aarch64</code><br/>🔋 <em>ARM64 (AArch64)</em>)
        all_traits_aix(<code>aix</code><br/>➿ <em>IBM AIX</em>)
        all_traits_altlinux(<code>altlinux</code><br/>🐧 <em>ALT Linux</em>)
        all_traits_amzn(<code>amzn</code><br/>⤻ <em>Amazon Linux</em>)
        all_traits_android(<code>android</code><br/>🤖 <em>Android</em>)
        all_traits_arch(<code>arch</code><br/>🎗️ <em>Arch Linux</em>)
        all_traits_arm(<code>arm</code><br/>📱 <em>ARM (32-bit)</em>)
        all_traits_armv6l(<code>armv6l</code><br/>📱 <em>ARMv6 (little-endian)</em>)
        all_traits_armv7l(<code>armv7l</code><br/>📱 <em>ARMv7 (little-endian)</em>)
        all_traits_armv8l(<code>armv8l</code><br/>📱 <em>ARMv8 (32-bit, little-endian)</em>)
        ...
        all_traits_buildkite(<code>buildkite</code><br/>🪁 <em>Buildkite</em>)
        all_traits_buildroot(<code>buildroot</code><br/>⛑️ <em>Buildroot</em>)
        all_traits_cachyos(<code>cachyos</code><br/>⌬ <em>CachyOS</em>)
        all_traits_centos(<code>centos</code><br/>💠 <em>CentOS</em>)
        all_traits_circle_ci(<code>circle_ci</code><br/>⪾ <em>Circle CI</em>)
        ...
        all_traits_codebuild(<code>codebuild</code><br/>ᚙ <em>CodeBuild</em>)
        all_traits_cygwin(<code>cygwin</code><br/>Ͼ <em>Cygwin</em>)
        all_traits_debian(<code>debian</code><br/>🌀 <em>Debian</em>)
        ...
        all_traits_gentoo(<code>gentoo</code><br/>🗜️ <em>Gentoo Linux</em>)
        all_traits_github_ci(<code>github_ci</code><br/>🐙 <em>GitHub Actions runner</em>)
        all_traits_gitlab_ci(<code>gitlab_ci</code><br/>🦊 <em>GitLab CI</em>)
        all_traits_guix(<code>guix</code><br/>🐃 <em>Guix System</em>)
        all_traits_heroku_ci(<code>heroku_ci</code><br/>⥁ <em>Heroku CI</em>)
        all_traits_hurd(<code>hurd</code><br/>🐃 <em>GNU/Hurd</em>)
        all_traits_i386(<code>i386</code><br/>🔲 <em>Intel 80386 (i386)</em>)
        all_traits_i586(<code>i586</code><br/>🔲 <em>Intel Pentium (i586)</em>)
        all_traits_i686(<code>i686</code><br/>🔲 <em>Intel Pentium Pro (i686)</em>)
        ...
        all_traits_loongarch64(<code>loongarch64</code><br/>🐉 <em>LoongArch (64-bit)</em>)
        all_traits_macos(<code>macos</code><br/>🍎 <em>macOS</em>)
        all_traits_mageia(<code>mageia</code><br/>⍥ <em>Mageia</em>)
        all_traits_mandriva(<code>mandriva</code><br/>💫 <em>Mandriva Linux</em>)
        all_traits_midnightbsd(<code>midnightbsd</code><br/>🌘 <em>MidnightBSD</em>)
        all_traits_mips(<code>mips</code><br/>🔧 <em>MIPS (32-bit, big-endian)</em>)
        all_traits_mips64(<code>mips64</code><br/>🔧 <em>MIPS64 (big-endian)</em>)
        all_traits_mips64el(<code>mips64el</code><br/>🔧 <em>MIPS64 (little-endian)</em>)
        all_traits_mipsel(<code>mipsel</code><br/>🔧 <em>MIPS (32-bit, little-endian)</em>)
        all_traits_netbsd(<code>netbsd</code><br/>🚩 <em>NetBSD</em>)
        all_traits_nobara(<code>nobara</code><br/> <em>Nobara</em>)
        ...
        all_traits_parallels(<code>parallels</code><br/>∥ <em>Parallels</em>)
        all_traits_pidora(<code>pidora</code><br/>🍓 <em>Pidora</em>)
        ...
        all_traits_raspbian(<code>raspbian</code><br/>🍓 <em>Raspbian</em>)
        ...
        all_traits_scientific(<code>scientific</code><br/>⚛️ <em>Scientific Linux</em>)
        ...
        all_traits_sparc(<code>sparc</code><br/>☀️ <em>SPARC (32-bit)</em>)
        all_traits_sparc64(<code>sparc64</code><br/>☀️ <em>SPARC (64-bit)</em>)
        all_traits_sunos(<code>sunos</code><br/>☀️ <em>SunOS</em>)
        all_traits_teamcity(<code>teamcity</code><br/>🏙️ <em>TeamCity</em>)
        all_traits_travis_ci(<code>travis_ci</code><br/>👷 <em>Travis CI</em>)
        ...
        all_traits_unknown_ci(<code>unknown_ci</code><br/>♲ <em>Unknown CI</em>)
        ...
        all_traits_windows(<code>windows</code><br/>🪟 <em>Windows</em>)
        ...
        all_traits_x86_64(<code>x86_64</code><br/>💻 <em>x86-64 (AMD64)</em>)
