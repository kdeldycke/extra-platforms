...
| `@skip_unknown`              | `@unless_unknown`              | [`UNKNOWN`](groups.md#extra_platforms.group_data.UNKNOWN)                                         | Unknown                                     |
...
| `@skip_unknown_platform`     | `@unless_unknown_platform`     | [`UNKNOWN_PLATFORM`](platforms.md#extra_platforms.platform_data.UNKNOWN_PLATFORM)                 | Unknown platform                            |
