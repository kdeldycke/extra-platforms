...
|  ⁕   | {data}`~ALL_TRAITS`         | All architectures, platforms, shells, terminals, CI systems, and agents | {func}`~is_any_trait`        |                                     |
...
:undoc-members:
:show-inheritance:
:exclude-members: Group, extract_members, groups_from_ids, reduce, 
  traits_from_ids
```
...
:exclude-members: ALL_AGENTS, ALL_ARCHITECTURES, ALL_ARCHITECTURE_GROUPS, 
  ALL_ARM, ALL_CI, ALL_CI_GROUPS, ALL_GROUPS, ALL_GROUP_IDS, ALL_IDS, ALL_MIPS, 
  ALL_PLATFORMS, ALL_PLATFORM_GROUPS, ALL_SHELLS, ALL_SHELL_GROUPS, ALL_SPARC, 
  ALL_TERMINALS, ALL_TERMINAL_GROUPS, ALL_TRAITS, ALL_TRAIT_IDS, ALL_WINDOWS, 
  ARCH_32_BIT, ARCH_64_BIT, BIG_ENDIAN, BOURNE_SHELLS, BSD, BSD_WITHOUT_MACOS, 
  C_SHELLS, EXTRA_GROUPS, GPU_TERMINALS, IBM_MAINFRAME, LINUX, LINUX_LAYERS, 
  LINUX_LIKE, LITTLE_ENDIAN, LOONGARCH, MULTIPLEXERS, NATIVE_TERMINALS, 
  NON_OVERLAPPING_GROUPS, OTHER_POSIX, OTHER_SHELLS, POWERPC, RISCV, SYSTEM_V, 
  UNIX, UNIX_LAYERS, UNIX_WITHOUT_MACOS, UNKNOWN, WEBASSEMBLY, WEB_TERMINALS, 
  WINDOWS_SHELLS, X86
```
