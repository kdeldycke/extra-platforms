...
|  📱  | [`ALL_ARM`](groups.md#extra_platforms.ALL_ARM)                       | ARM architectures                           | [`is_any_arm()`](detection.md#extra_platforms.is_any_arm)                       |                              ⬥                               |
|  ♺   | [`ALL_CI`](groups.md#extra_platforms.ALL_CI)                         | CI systems                                  | [`is_any_ci()`](detection.md#extra_platforms.is_any_ci)                         |                              ⬥                               |
|  🔲  | [`ALL_MIPS`](groups.md#extra_platforms.ALL_MIPS)                     | MIPS architectures                          | [`is_any_mips()`](detection.md#extra_platforms.is_any_mips)                     |                              ⬥                               |
...
|  ☀️  | [`ALL_SPARC`](groups.md#extra_platforms.ALL_SPARC)                   | SPARC architectures                         | [`is_any_sparc()`](detection.md#extra_platforms.is_any_sparc)                   |                              ⬥                               |
...
|  🅱️  | [`BSD_WITHOUT_MACOS`](groups.md#extra_platforms.BSD_WITHOUT_MACOS)   | All BSD excluding macOS                     | [`is_bsd_without_macos()`](detection.md#extra_platforms.is_bsd_without_macos)   |                                                              |
...
|  ⨂   | [`UNIX_WITHOUT_MACOS`](groups.md#extra_platforms.UNIX_WITHOUT_MACOS) | All Unix excluding macOS                    | [`is_unix_without_macos()`](detection.md#extra_platforms.is_unix_without_macos) |                                                              |
