...
flowchart
    ...
    subgraph "<code>extra_platforms.CI</code><br/>♺ <em>CI systems</em>"
        ci_azure_pipelines(<code>azure_pipelines</code><br/>═ <em>Azure Pipelines</em>)
        ci_bamboo(<code>bamboo</code><br/>⟲ <em>Bamboo</em>)
        ci_buildkite(<code>buildkite</code><br/>🪁 <em>Buildkite</em>)
        ci_circle_ci(<code>circle_ci</code><br/>⪾ <em>Circle CI</em>)
        ci_cirrus_ci(<code>cirrus_ci</code><br/>≋ <em>Cirrus CI</em>)
        ci_codebuild(<code>codebuild</code><br/>ᚙ <em>CodeBuild</em>)
        ci_github_ci(<code>github_ci</code><br/>🐙 <em>GitHub Actions runner</em>)
        ci_gitlab_ci(<code>gitlab_ci</code><br/>🦊 <em>GitLab CI</em>)
        ci_heroku_ci(<code>heroku_ci</code><br/>⥁ <em>Heroku CI</em>)
        ci_teamcity(<code>teamcity</code><br/>🏙️ <em>TeamCity</em>)
        ci_travis_ci(<code>travis_ci</code><br/>👷 <em>Travis CI</em>)
...
flowchart
    ...
    subgraph "<code>extra_platforms.ALL_PLATFORMS</code><br/>⚙️ <em>All platforms</em>"
        ...
        all_platforms_bamboo(<code>bamboo</code><br/>⟲ <em>Bamboo</em>)
        all_platforms_buildkite(<code>buildkite</code><br/>🪁 <em>Buildkite</em>)
        ...
        all_platforms_circle_ci(<code>circle_ci</code><br/>⪾ <em>Circle CI</em>)
        all_platforms_cirrus_ci(<code>cirrus_ci</code><br/>≋ <em>Cirrus CI</em>)
        all_platforms_cloudlinux(<code>cloudlinux</code><br/>꩜ <em>CloudLinux OS</em>)
        all_platforms_codebuild(<code>codebuild</code><br/>ᚙ <em>CodeBuild</em>)
        ...
        all_platforms_heroku_ci(<code>heroku_ci</code><br/>⥁ <em>Heroku CI</em>)
        ...
        all_platforms_teamcity(<code>teamcity</code><br/>🏙️ <em>TeamCity</em>)
        all_platforms_travis_ci(<code>travis_ci</code><br/>👷 <em>Travis CI</em>)
    ...
    subgraph "<code>extra_platforms.ALL_PLATFORMS_WITHOUT_CI</code><br/>🖥️ <em>Any platforms excluding CI systems</em>"
        ...
        all_platforms_without_ci_cachyos(<code>cachyos</code><br/>⌬ <em>CachyOS</em>)
        all_platforms_without_ci_centos(<code>centos</code><br/>💠 <em>CentOS</em>)
        all_platforms_without_ci_cloudlinux(<code>cloudlinux</code><br/>꩜ <em>CloudLinux OS</em>)
        all_platforms_without_ci_cygwin(<code>cygwin</code><br/>Ͼ <em>Cygwin</em>)
        all_platforms_without_ci_debian(<code>debian</code><br/>🌀 <em>Debian</em>)
        all_platforms_without_ci_exherbo(<code>exherbo</code><br/>🐽 <em>Exherbo Linux</em>)
        all_platforms_without_ci_fedora(<code>fedora</code><br/>🎩 <em>Fedora</em>)
        all_platforms_without_ci_freebsd(<code>freebsd</code><br/>😈 <em>FreeBSD</em>)
        all_platforms_without_ci_gentoo(<code>gentoo</code><br/>🗜️ <em>Gentoo Linux</em>)
        all_platforms_without_ci_guix(<code>guix</code><br/>🐃 <em>Guix System</em>)
        all_platforms_without_ci_hurd(<code>hurd</code><br/>🐃 <em>GNU/Hurd</em>)
        all_platforms_without_ci_ibm_powerkvm(<code>ibm_powerkvm</code><br/>🤹 <em>IBM PowerKVM</em>)
        all_platforms_without_ci_kvmibm(<code>kvmibm</code><br/>🤹 <em>KVM for IBM z Systems</em>)
        all_platforms_without_ci_linuxmint(<code>linuxmint</code><br/>🌿 <em>Linux Mint</em>)
        all_platforms_without_ci_macos(<code>macos</code><br/>🍎 <em>macOS</em>)
        all_platforms_without_ci_mageia(<code>mageia</code><br/>⍥ <em>Mageia</em>)
        all_platforms_without_ci_mandriva(<code>mandriva</code><br/>💫 <em>Mandriva Linux</em>)
        all_platforms_without_ci_midnightbsd(<code>midnightbsd</code><br/>🌘 <em>MidnightBSD</em>)
        all_platforms_without_ci_netbsd(<code>netbsd</code><br/>🚩 <em>NetBSD</em>)
        all_platforms_without_ci_nobara(<code>nobara</code><br/> <em>Nobara</em>)
        all_platforms_without_ci_openbsd(<code>openbsd</code><br/>🐡 <em>OpenBSD</em>)
        all_platforms_without_ci_opensuse(<code>opensuse</code><br/>🦎 <em>openSUSE</em>)
        all_platforms_without_ci_oracle(<code>oracle</code><br/>🦴 <em>Oracle Linux</em>)
        all_platforms_without_ci_parallels(<code>parallels</code><br/>∥ <em>Parallels</em>)
        all_platforms_without_ci_pidora(<code>pidora</code><br/>🍓 <em>Pidora</em>)
        all_platforms_without_ci_raspbian(<code>raspbian</code><br/>🍓 <em>Raspbian</em>)
        all_platforms_without_ci_rhel(<code>rhel</code><br/>🎩 <em>RedHat Enterprise Linux</em>)
        all_platforms_without_ci_rocky(<code>rocky</code><br/>⛰️ <em>Rocky Linux</em>)
        all_platforms_without_ci_scientific(<code>scientific</code><br/>⚛️ <em>Scientific Linux</em>)
        all_platforms_without_ci_slackware(<code>slackware</code><br/>🚬 <em>Slackware</em>)
        all_platforms_without_ci_sles(<code>sles</code><br/>🦎 <em>SUSE Linux Enterprise Server</em>)
        all_platforms_without_ci_solaris(<code>solaris</code><br/>🌞 <em>Solaris</em>)
        all_platforms_without_ci_sunos(<code>sunos</code><br/>☀️ <em>SunOS</em>)
        all_platforms_without_ci_tumbleweed(<code>tumbleweed</code><br/>↻ <em>openSUSE Tumbleweed</em>)
        all_platforms_without_ci_tuxedo(<code>tuxedo</code><br/>🤵 <em>Tuxedo OS</em>)
        all_platforms_without_ci_ubuntu(<code>ubuntu</code><br/>🎯 <em>Ubuntu</em>)
        all_platforms_without_ci_ultramarine(<code>ultramarine</code><br/>🌊 <em>Ultramarine</em>)
        all_platforms_without_ci_unknown_linux(<code>unknown_linux</code><br/>🐧 <em>Unknown Linux</em>)
        all_platforms_without_ci_windows(<code>windows</code><br/>🪟 <em>Windows</em>)
        all_platforms_without_ci_wsl1(<code>wsl1</code><br/>⊞ <em>Windows Subsystem for Linux v1</em>)
        all_platforms_without_ci_wsl2(<code>wsl2</code><br/>⊞ <em>Windows Subsystem for Linux v2</em>)
        all_platforms_without_ci_xenserver(<code>xenserver</code><br/>Ⓧ <em>XenServer</em>)
    end
