...
Or inspect the current environment straight from your terminal with the bundled [CLI](cli.md):
...
| `extra-platforms`   | Released   | `3.15` | `3.14` | `3.13` | `3.12` | `3.11` | `3.10` | `3.9` | `3.8` |
| :------------------ | :--------- | :----: | :----: | :----: | :----: | :----: | :----: | :---: | :---: |
| `13.10.1`           | 2026-09-19 |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |
| `5.0.x` → `13.10.x` | 2025-11-03 |   –    |   ✅   |   ✅   |   ✅   |   ✅   |   ✅   |  ❌   |  ❌   |
| `4.x`               | 2025-10-21 |   –    |   ✅   |   ✅   |   ✅   |   ✅   |   ❌   |  ❌   |  ❌   |
| `3.x`               | 2025-03-02 |   –    |   –    |   ✅   |   ✅   |   ✅   |   ❌   |  ❌   |  ❌   |
